...
export default function Room() {
    ...
    const chatScrollRef = useRef(null); // Used to auto-scroll to latest message
    ...
    // --- NEW: Function to send a text message ---
    const sendChatMessage = (e) => {
        ...
        // Send to server (No target_id, so backend will broadcast it!)
        wsRef.current.send(JSON.stringify(msgPayload));

        // Add to our own local screen
